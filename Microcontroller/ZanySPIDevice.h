#ifndef Zany_SPIDevice_h
#define Zany_SPIDevice_h
...
class Zany_SPIDevice {
public:
  Zany_SPIDevice(int8_t cspin, uint32_t freq = 1000000,
                     BusIOBitOrder dataOrder = SPI_BITORDER_MSBFIRST,
                     uint8_t dataMode = SPI_MODE0, SPIClass *theSPI = &SPI);

  Zany_SPIDevice(int8_t cspin, int8_t sck, int8_t miso, int8_t mosi,
