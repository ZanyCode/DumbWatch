...
*********************************************************************/
#ifndef LIB_ZANY_SHARPMEM
#define LIB_ZANY_SHARPMEM
 ...
 *
 */
class ZanyDisplayLib : public Adafruit_GFX {
public:
  ZanyDisplayLib(uint8_t clk, uint8_t mosi, uint8_t cs, uint16_t w = 96,
                    uint16_t h = 96, uint32_t freq = 2000000);
  ZanyDisplayLib(SPIClass *theSPI, uint8_t cs, uint16_t w = 96,
                    uint16_t h = 96, uint32_t freq = 2000000);
  boolean begin();
